...
const entryPlanCss = '<style id="aristocks-entry-plan-css">#aristocks-calculator .entry-plan[hidden]{display:none}#aristocks-calculator .entry-plan summary strong{color:inherit;font-weight:500}#aristocks-calculator .entry-leg{position:relative;padding:0 30px 14px 0;display:grid;grid-template-columns:1fr 1fr;gap:10px 12px}#aristocks-calculator .entry-leg+.entry-leg{padding-top:14px;border-top:1px solid var(--line)}#aristocks-calculator .entry-leg .field{gap:6px}#aristocks-calculator .entry-leg .field input{height:42px;font-size:13px}#aristocks-calculator .entry-leg-remove{position:absolute;right:0;top:27px;width:24px;height:24px;padding:0;border:0;color:#7a8380;background:transparent;font:400 18px/1 var(--mono);cursor:pointer}#aristocks-calculator .entry-leg+.entry-leg .entry-leg-remove{top:41px}#aristocks-calculator .entry-leg-remove:hover{color:var(--red)}#aristocks-calculator .add-entry-leg{padding:6px 0;border:0;border-bottom:1px solid #bfc5c2;color:var(--violet);background:transparent;font-size:10px;cursor:pointer}#aristocks-calculator .add-entry-leg:disabled{color:#929997;cursor:not-allowed}#aristocks-calculator .average-entry{display:block;margin-top:14px;padding:10px 12px;border-left:2px solid var(--violet);color:#25302d;background:#f7f5ff;font:600 11px/1.5 var(--mono)}#aristocks-calculator .average-entry.warning{border-color:#c68138;color:#795314;background:#fff0cf}#aristocks-calculator .entry-plan-note{margin:8px 0 0;color:#68716f;font-size:9px;line-height:1.5}@media(max-width:720px){#aristocks-calculator .entry-leg{grid-template-columns:minmax(0,1fr) minmax(96px,.55fr);padding-right:42px}#aristocks-calculator .entry-leg .field input{height:54px;min-height:54px;font-size:16px}#aristocks-calculator .entry-leg-remove{top:31px;width:44px;height:44px}#aristocks-calculator .entry-leg+.entry-leg .entry-leg-remove{top:45px}#aristocks-calculator .add-entry-leg{min-height:44px;font-size:13px}#aristocks-calculator .average-entry{font-size:13px}#aristocks-calculator .entry-plan-note{font-size:12px}}</style>';
embed = embed.replace(/<style id="aristocks-entry-plan-css">[\s\S]*?<\/style>/, entryPlanCss);
if (!embed.includes('id="aristocks-entry-plan-css"')) {
  const insertAt = embed.indexOf('<div id="aristocks-calculator">');
...
if (!embed.includes('id="aristocks-position-direction-css"')) {
  const insertAt = embed.indexOf('<div id="aristocks-calculator">');
  embed = embed.slice(0, insertAt) + positionDirectionCss + embed.slice(insertAt);
}
